import { IOurMissionMain } from "@/app/types/Interfaces";
import { useTranslation } from "next-i18next";
import Link from "next/link";
import { useRouter } from "next/router";
import { LuArrowUpRight } from "react-icons/lu";

export default function OurMissionSection({ mainData }: { mainData: IOurMissionMain }) {
    ...
    <section className="w-full px-[16px] 1160:pr-0 1160:pl-[36px] mb-[80px] flex flex-col items-center 1160:flex-row-reverse overflow-hidden">
      ...
      <div className="1160:w-[40%]">
        ...
        <Link href="/contact-us"
          locale={router.locale} className="w-full 1160:w-fit max-w-[700px] h-[56px] border-[2px] border-main_green rounded-[50px] mx-auto 1160:mx-0 mt-[20px] px-[20px] flex items-center justify-center gap-[8px] cursor-pointer hover:bg-main_green duration-300 text-main_green hover:text-white">
